...
class modules_structure_attr {
    ...
    function getAttributeSection ($attrName = '', $idSection = '') {
        ...
        if (isset($system['section'][$idSection][$attrName]) == false) {
    ...
    function getAttributeDynamic ($attrName = '', $idSection = '') {
        ...
        if ($attrName == '_url') {
            ...
            if (isset($system['tplLevel'][ modules_structure_tpl::getTplLevelLast() ]['countChild']) &&
            ...
            if (isset($system['tplLevel'][ modules_structure_tpl::getTplLevelLast() ]['part']) &&
